...
public final class MTRClient {
	...
	public static void init() {
		...
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.APG_DOOR);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.APG_GLASS);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.APG_GLASS_END);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.CABLE_CAR_NODE_LOWER);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.CABLE_CAR_NODE_UPPER);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.CLOCK);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_TRANSLUCENT, Blocks.GLASS_FENCE_CIO);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_TRANSLUCENT, Blocks.GLASS_FENCE_CKT);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_TRANSLUCENT, Blocks.GLASS_FENCE_HEO);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_TRANSLUCENT, Blocks.GLASS_FENCE_MOS);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_TRANSLUCENT, Blocks.GLASS_FENCE_PLAIN);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_TRANSLUCENT, Blocks.GLASS_FENCE_SHM);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_TRANSLUCENT, Blocks.GLASS_FENCE_STAINED);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_TRANSLUCENT, Blocks.GLASS_FENCE_STW);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_TRANSLUCENT, Blocks.GLASS_FENCE_TSH);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_TRANSLUCENT, Blocks.GLASS_FENCE_WKS);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.LOGO);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PLATFORM);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PLATFORM_INDENTED);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PLATFORM_SLAB);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PLATFORM_NA_1);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PLATFORM_NA_1_INDENTED);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PLATFORM_NA_1_SLAB);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PLATFORM_NA_2);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PLATFORM_NA_2_INDENTED);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PLATFORM_NA_2_SLAB);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PLATFORM_UK_1);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PLATFORM_UK_1_INDENTED);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PLATFORM_UK_1_SLAB);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PSD_DOOR_1);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PSD_GLASS_1);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PSD_GLASS_END_1);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PSD_DOOR_2);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PSD_GLASS_2);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.PSD_GLASS_END_2);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.RUBBISH_BIN_1);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_TRANSLUCENT, Blocks.STATION_COLOR_STAINED_GLASS);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_TRANSLUCENT, Blocks.STATION_COLOR_STAINED_GLASS_SLAB);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.STATION_NAME_TALL_BLOCK);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.STATION_NAME_TALL_BLOCK_DOUBLE_SIDED);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.STATION_NAME_TALL_WALL);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.STATION_NAME_TALL_STANDING);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.TICKET_BARRIER_ENTRANCE_1);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.TICKET_BARRIER_EXIT_1);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.TICKET_MACHINE);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.TICKET_PROCESSOR);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.TICKET_PROCESSOR_ENTRANCE);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.TICKET_PROCESSOR_EXIT);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.TICKET_PROCESSOR_ENQUIRY);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.TRAIN_ANNOUNCER);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.TRAIN_CARGO_LOADER);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.TRAIN_CARGO_UNLOADER);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.TRAIN_REDSTONE_SENSOR);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.TRAIN_SCHEDULE_SENSOR);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.LIFT_DOOR_EVEN_1);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.LIFT_DOOR_ODD_1);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.LIFT_PANEL_EVEN_1);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.LIFT_PANEL_ODD_1);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.LIFT_PANEL_EVEN_2);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.LIFT_PANEL_ODD_2);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.ESCALATOR_STEP);
		RegistryClient.registerBlockRenderType(RegistryClient.BLOCK_RENDER_LAYER_CUTOUT, Blocks.ESCALATOR_SIDE);
		...
		EventRegistryClient.registerStartClientTick(() -> {
			...
			if (clientPlayerEntity != null && lastUpdatePacketMillis > 0 && getGameMillis() > lastUpdatePacketMillis) {
				final DataRequest dataRequest = new DataRequest(clientPlayerEntity.getUUID(), MTR.blockPosToPosition(Minecraft.getInstance().gameRenderer.getMainCamera().blockPosition()), (int) Minecraft.getInstance().levelRenderer.getLastViewDistance() * 16L);
...
*///? }
	...
	public interface WorldRenderCallback {
		void accept(PoseStack matrixStack, MultiBufferSource vertexConsumerProvider, Vec3 offset, net.minecraft.client.renderer.SubmitNodeCollector submitNodeCollector, net.minecraft.client.renderer.state.CameraRenderState cameraRenderState);
	}
