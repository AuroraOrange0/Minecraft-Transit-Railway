...
public class ItemLiftRefresher extends Item {
	...
	public ActionResult useOnBlock(ItemUsageContext context) {
		...
		if (world.isClient() || playerEntity == null) {
			...
			RegistryServer.sendPacketToClient((ServerPlayerEntity) playerEntity, new PacketOpenLiftCustomizationScreen(MTR.positionToBlockPos(liftFloors.getFirst().getPosition())));
